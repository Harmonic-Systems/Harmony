...
HarmonyRagUserTask = Literal["code", "qa", "default"]
HarmonyRagUserVectorDb = Literal["chroma", "pgvector", "mongodb", "qdrant"]
HarmonyRagUserChunkMode = Literal["multi_lines", "one_line"]
HarmonyRagUserModels: Dict[HarmonyRagUserVectorDb, str] = {
...
class HarmonyRagUserRetrieveConfig(HarmonyBase):
    """RAG user agent.
    ...
    db_config : Annotated[HarmonyVectorDbConfig, Field]
    ...
    db_config: Annotated[
        ...
        Field(
            ...
            default_factory=HarmonyRagUserVectorDbConfig,
        ),
    ]
    docs_path: Annotated[
    ...
    def validate_custom_embedding_function(self) -> None:
        ...
        if self.use_custom_embedding:
            ...
            function_name: HarmonyMethodName = "custom_embedding_function"
    ...
    def validate_custom_token_count_function(self) -> None:
        ...
        if self.use_custom_token_count:
            ...
            function_name: HarmonyMethodName = "custom_token_count_function"
            valid, error_or_content = check_function(
    ...
    def validate_custom_text_split_function(self) -> None:
        ...
        if self.use_custom_text_split:
            ...
            function_name: HarmonyMethodName = "custom_text_split_function"
            valid, error_or_content = check_function(
    ...
    def validate_rag_user_data(self) -> Self:
        ...
        if not self.db_config.model:
            self.db_config.model = HarmonyRagUserModels[self.vector_db]
