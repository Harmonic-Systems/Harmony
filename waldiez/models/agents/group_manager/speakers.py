...
HarmonyGroupManagerSpeakersSelectionMethod = Literal[
    "auto",
    "manual",
    "random",
    "round_robin",
...
HarmonyGroupManagerSpeakersSelectionMode = Literal["repeat", "transition"]
HarmonyGroupManagerSpeakersTransitionsType = Literal["allowed", "disallowed"]


class HarmonyGroupManagerSpeakers(HarmonyBase):
    """Group chat speakers.
    ...
    Attributes
    ----------
    selection_method : HarmonyGroupManagerSpeakersSelectionMethod
    ...
    def validate_group_speakers_config(self) -> Self:
        ...
        if self.selection_method == "custom":
            ...
            function_name: HarmonyMethodName = "custom_speaker_selection"
