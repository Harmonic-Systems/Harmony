...
class HarmonyFlow(HarmonyBase):
    ...
    data : HarmonyFlowData
        The data of the flow. See `HarmonyFlowData`.
    """
    ...
    _ordered_flow: Optional[
        List[Tuple[HarmonyChat, HarmonyAgent, HarmonyAgent]]
    ] = None
    ...
    def get_agent_by_id(self, agent_id: str) -> HarmonyAgent:
        """Get the agent by ID.
    ...
    def _get_flow_order(
        ...
        ordered_flow: List[Tuple[HarmonyChat, HarmonyAgent, HarmonyAgent]] = []
