...
from .model_data import HarmonyModelAPIType, HarmonyModelData

DEFAULT_BASE_URLS: Dict[HarmonyModelAPIType, str] = {
...
class HarmonyModel(HarmonyBase):
    ...
    data : HarmonyModelData
        ...
        See `harmony.models.model.HarmonyModelData` for more information.
    """
...
def set_default_base_url(
    llm_config: Dict[str, Any], api_type: HarmonyModelAPIType
) -> Dict[str, Any]:
