...
from harmony.models import HarmonyModel
...
def export_models(
    ...
    -------
    ```python
    >>> from harmony.models import HarmonyModel, HarmonyModelData
    >>> api_key = "1234567890"
    ... model = HarmonyModel(
    ...     id="wm-1",
    ...     name="llama3.1"  ,
...
'''
    ...
    with open(output_dir / "harmony_api_keys.py", "w", encoding="utf-8") as f:
