...
from harmony.models import HarmonyAgent, HarmonyModel, HarmonySkill
...
def get_agent_class_name(agent: HarmonyAgent) -> str:
...
def get_system_message_arg(agent: HarmonyAgent) -> str:
