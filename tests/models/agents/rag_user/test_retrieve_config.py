"""Test harmony.models.agents.rag_user.retrieve_config.*."""

import pytest

from harmony.models.agents.rag_user.retrieve_config import (
...
def test_harmony_rag_user_retrieve_config() -> None:
    """Test HarmonyRagUserRetrieveConfig."""
...
def test_harmony_rag_user_retrieve_config_custom_embedding() -> None:
    """Test HarmonyRagUserRetrieveConfig with custom embedding."""
    embedding_function = """
...
"""
    ...
    with pytest.raises(ValueError):
        HarmonyRagUserRetrieveConfig(  # type: ignore
            use_custom_embedding=True,
            embedding_function=None,
        )
...
def test_harmony_rag_user_retrieve_config_custom_token_count() -> None:
    """Test HarmonyRagUserRetrieveConfig with custom token count."""
...
"""  # nosemgrep # nosec
    ...
    with pytest.raises(ValueError):
        HarmonyRagUserRetrieveConfig(  # type: ignore  # nosemgrep # nosec
            use_custom_token_count=True,
...
def test_harmony_rag_user_retrieve_config_custom_text_split() -> None:
    """Test HarmonyRagUserRetrieveConfig with custom text split."""
    text_split_function = """
