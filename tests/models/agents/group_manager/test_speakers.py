"""Test harmony.models.agents.group_manager.speakers.*."""

# pylint: disable=line-too-long

import pytest

from harmony.models.agents.group_manager.speakers import (
    HarmonyGroupManagerSpeakers,
)


def test_harmony_group_manager_speakers() -> None:
    """Test HarmonyGroupManagerSpeakers."""
    # Given
    speakers_config = HarmonyGroupManagerSpeakers(
