# type: ignore
"""Tests for the `HarmonyIOStream` class."""
...
@pytest.fixture
def setup_custom_stream() -> HarmonyIOStream:
    """Fixture to set up a `HarmonyIOStream` instance.
...
def test_print_function(setup_custom_stream: HarmonyIOStream) -> None:
    """Test the custom print function.

    Parameters
    ----------
    setup_custom_stream : HarmonyIOStream
        The custom stream instance.
    """
...
def test_input_with_prompt(setup_custom_stream: HarmonyIOStream) -> None:
...
def test_input_timeout(setup_custom_stream: HarmonyIOStream) -> None:
...
def test_set_input(setup_custom_stream: HarmonyIOStream) -> None:
...
def test_default_print() -> None:
    ...
    stream = HarmonyIOStream(input_timeout=2)
